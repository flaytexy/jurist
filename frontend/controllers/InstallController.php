...
use frontend\modules\carousel\models\Carousel;
use frontend\modules\catalog;
use frontend\modules\article;
use frontend\modules\faq\models\Faq;
use frontend\modules\file\models\File;
use frontend\modules\gallery;
use frontend\modules\guestbook\models\Guestbook;
use frontend\modules\news\models\News;
use frontend\modules\page\models\Page;
use frontend\modules\text\models\Text;
