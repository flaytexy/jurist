 ...
 * @var \frontend\modules\novanews\models\Novanews|array $models
    ...
    <div class="title-block">
        <div class="row">
            <div class="col-md-6">
                <h3 class="title">
                    Статьи
                    <a href="<?= Url::to(['/admin/novanews/default/edit', 'id' => 0]); ?>" class="btn btn-primary btn-sm rounded-s">
                        добавить
                    </a>
                </h3>
            </div>
                ...
                <div class="item-col item-col-header item-col-title">
                    ...
                    <div>
                        <? if (TRUE): ?>
                            ...
                            <?
                            $searchform = ActiveForm::begin(['action' => '/admin/novanews',
                                'method' => 'post',
                            ]);
