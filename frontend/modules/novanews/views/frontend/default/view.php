            ...
            <div class="press__items__item__desc">
                <?php if ($prev) { ?>
                    <div class="press_prev_item">
                        <a href="<?= Url::to(['/novanews/default/view', 'id' => $prev['id']]); ?>" title="<?= $prev['translation']['title'] ?>"><?= Yii::t('app', 'Previous novanews'); ?></a>
                    </div>
                <?php } ?>
                <?php if ($next) { ?>
                    <div class="press_next_item">
                        <a href="<?= Url::to(['/novanews/default/view', 'id' => $next['id']]); ?>" title="<?= $next['translation']['title'] ?>"><?= Yii::t('app', 'Next novanews'); ?></a>
                    </div>
                <?php } ?>
