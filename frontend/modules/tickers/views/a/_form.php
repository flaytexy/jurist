...
<?php if ($this->context->module->settings['enableThumb']) : ?>
    <?php if ($model->image) : ?>
        ...
        <a href="<?= Url::to(['/admin/' . $module . '/a/clear-image', 'id' => $model->ticker_id]) ?>"
...
<? /*= $form->field($model, 'text')->widget(Redactor::className(), [
    'options' => [
        'minHeight' => 400,
        'imageUpload' => Url::to(['/admin/redactor/upload', 'dir' => 'tickers']),
        'fileUpload' => Url::to(['/admin/redactor/upload', 'dir' => 'tickers']),
        'plugins' => ['fullscreen']
    ]
]) */ ?>
