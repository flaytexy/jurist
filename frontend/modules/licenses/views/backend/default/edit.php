 ...
 * @var \frontend\modules\Licenses\models\LicensesTranslation|array $translation_models
 */
        ...
        <div class="card card-block">
            ...
            foreach ($translation_models as $language => $translation_model) {
                echo $form->field($translation_model, "[$language]public_status", ['options' => ['class' => 'form-group language_' . $language . ($model->language !== $language ? ' hidden' : '')]])
                    ...
                    ->dropDownList(
                        [
                            Licenses::STATUS_OFF => 'Черновик',
                            Licenses::STATUS_ON => 'Опубликовано',
                        ],
                        [
...
<!--            </div>-->
        ...
        <?php if (false) : ?>
            ...
            <div>
                <?php
                // http://loc.ak.yabloko.studio/admin/Licenses/default/cropImage?id=dfjksjkfsfd
