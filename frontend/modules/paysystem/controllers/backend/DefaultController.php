...
namespace frontend\modules\paysystem\controllers\backend;

use common\controllers\ContentAdminController;
use common\models\Language;

use frontend\modules\paysystem\models\Banks;
use frontend\modules\paysystem\models\Paysystem;
use frontend\modules\paysystem\models\PaysystemTranslation;
...
class DefaultController extends ContentAdminController
{
    public function actions()
    {
        return [
            'deleteImage' => [
                ...
                'modelClass' => Paysystem::className(),
    ...
    public function actionIndex()
    {
        $query = Paysystem::find()
            ...
            //->groupBy(Paysystem::tableName() . '.id');
            ->orderBy([Paysystem::tableName() . '.time' => SORT_DESC]); //publish_date' => SORT_DESC
        //->limit();
    ...
    public function actionEdit($id)
    {
        ...
        /**
         * @var Paysystem $model
         * @var PaysystemTranslation|array $translation_models
         * @var PaysystemTranslation $translation_model
         */
        $model = Paysystem::find()
            ->where([Paysystem::tableName() . '.id' => $id])
            ->with('translations')
            ->with('child')
            ->with('images')
        ...
        if ($model instanceof Paysystem) {
            ...
            if ($id) {
                return $this->redirect(['/admin/paysystem/default/index']);
            }
            ...
            $model->category_detail = Paysystem::TYPE_ID . ':20';
        }
    ...
    public function actionDelete($id)
    {
        /**
         * @var Paysystem $model
         * @var PaysystemTranslation $translation
         */
        ...
        return $this->redirect(Url::to(['/admin/paysystem/default/index']));
    }
