 ...
 *
 * @property SaleTranslation|array $translations
 */
class Sale extends Content
{
    ...
    public static $_type = 'sale';

    public function init()
    {
        self::$_translateModel = SaleTranslation::className();
    }
...
//            ],
    ...
    public function getChild() {
        return $this->getSaleExt();
    }

    public function getSaleExt() {
        return $this->hasOne(SaleExt::className(), ['content_id' => 'id']);
    }
}
