 ...
 * @var \frontend\modules\sale\models\Sale|array $models
    ...
    <div class="title-block">
        <div class="row">
            <div class="col-md-6">
                <h3 class="title">
                   Предложения
                    <a href="<?= Url::to(['/admin/sale/default/edit', 'id' => 0]); ?>" class="btn btn-primary btn-sm rounded-s">
                        добавить
                    </a>
                </h3>
            </div>
        ...
        <li class="item item-list-header hidden-sm-down">
            <div class="item-row">
                <div class="item-col item-col-header item-col-title">
                    <div> <span>Предложения</span> </div>
                </div>
                <div>


                    <?
                    $searchform = ActiveForm::begin(['action' => '/admin/sale',
                        'method' => 'post',
                    ]);
