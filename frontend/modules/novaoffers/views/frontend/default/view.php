 ...
 * @var \frontend\modules\novaoffers\models\Novaoffers $next
 */
            ...
            <div class="press__items__item__desc">
                <?php if ($prev) { ?>
                    <div class="press_prev_item">
                        <a href="<?= Url::to(['/novaoffers/default/view', 'id' => $prev['id']]); ?>" title="<?= $prev['translation']['title'] ?>"><?= Yii::t('app', 'Previous novaoffers'); ?></a>
                    </div>
                <?php } ?>
                <?php if ($next) { ?>
                    <div class="press_next_item">
                        <a href="<?= Url::to(['/novaoffers/default/view', 'id' => $next['id']]); ?>" title="<?= $next['translation']['title'] ?>"><?= Yii::t('app', 'Next novaoffers'); ?></a>
                    </div>
                <?php } ?>
