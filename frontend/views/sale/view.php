...
$this->params['breadcrumbs'][] = ['label' => 'Предложения','url' => ['sale/index']];
                        ...
                        <?php if (!empty($page->model->image)) : ?>
                            <div class="package-video">
                                <div>
                                    ...
                                    <? endif ?>
                                    <?php if ( $page->model->child->price >0): ?>
                                        <strong class="per-night" style="font-family: Arial"> <?php if ($page->model->child->price_prefix): ?><?=Yii::t('easyii','From')?>  <?endif; ?><span>€</span><?= $page->model->child->price; ?> </strong>
