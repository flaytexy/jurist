...
<? if (true): ?>
    <section>
        <div class="block no-padding">
            <div class="row">
                <div class="col-md-12">
                    <div id="Slider-Main" class="Modern-Slider">
                        <!-- Item -->
                        <div class="item">
                        ...
                        <div class="item">
                            <div class="img-fill-main">
                                <img src="https://googledrive.com/host/0B1RR6fhjI2QRbXA4RjVjQ2NxeFk/2.jpg" alt="">
                                <div class="info">
                                    <div>
                        ...
                        <div class="item">
                            <div class="img-fill-main">
                                <img src="https://googledrive.com/host/0B1RR6fhjI2QRbXA4RjVjQ2NxeFk/3.jpg" alt="">
                                <div class="info">
                                    <div>
                        ...
                        <div class="item">
                            <div class="img-fill-main">
                                <img src="https://googledrive.com/host/0B1RR6fhjI2QRbXA4RjVjQ2NxeFk/4.jpg" alt="">
                                <div class="info">
                                    <div>
                            ...
                            <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;">
                                <ul>
                                    ...
                                    <li data-index="rs-2" data-transition="random" data-slotamount="default"
                                        ...
                                        <!-- MAIN IMAGE -->
                                        <img src="/uploads/theme_villa/slider2-3.jpg" alt=""
                                             data-bgposition="center center"
                                             data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="45"
                                             class="rev-slidebg" data-no-retina/>
