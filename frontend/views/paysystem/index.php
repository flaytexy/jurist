 ...
 * @var \frontend\modules\paysystem\api\PaysystemObject[] $items
 *
 * @var \frontend\modules\novanews\api\NovanewsObject[] $top_news
 * @var \frontend\modules\paysystem\api\PaysystemObject[] $top_banks
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <div class="package">
                                                    <div class="package-thumb">
                                                        ...
                                                        <span><b><? if ($item->model->child->countries[0]->name_ru): ?><?= $item->countries[0]->name_ru ?><? else: ?><?= $item->model->bank->location_title ?><? endif; ?></b></span>
                                                    </div>
                            ...
                            <div id="pagination">
                                <div>
                                    <?= \frontend\modules\paysystem\api\Paysystem::pages() ?>
                                </div>
                            </div>
                            <!-- Pagination -->
                        </div>
