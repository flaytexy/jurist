                ...
                <div class="col-md-12">
                    ...
                    <div class="packages-detail">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="carousel-client">
                                        <?php foreach ($offersList as $itemList) : ?>
                                            <div class="slide"><h3><a href="<?= Url::to(['offers/'.$itemList->slug]) ?>"><?=$itemList->title?><br><b>€<?= $itemList->price ?></b></a></h3></div>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="package-video">
                            ...
                            <strong class="per-night" style="font-family: Arial"><span>
                                    <?php if ($offers->price_prefix):?> <?=Yii::t('easyii','From')?> <?php  endif; ?>
                                    €</span><?= $offers->price; ?>
                                <i><?= Yii::t('easyii', 'days') ?>: <?= $offers->how_days; ?></i></strong>
