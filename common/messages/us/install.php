...
return [
    ...
    'NNNCMS is already installed. If you want to reinstall nnnCMS, please drop all tables with prefix `easyii_` from your database manually.' => 'NNNCMS уже установлена. Если вы хотите произвести переустановку, удалите все таблицы с префиксом `easyii_` в вашей базе данных.'
];