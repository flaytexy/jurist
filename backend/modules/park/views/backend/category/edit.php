 ...
 * @var \backend\modules\park\models\Category $model
 * @var \backend\modules\park\models\CategoryTranslation|array $translation_models
 */
...
<div class="item-editor-page">
    ...
    <div class="title-block">
        <h3 class="title"> <?= $model->isNewRecord ? 'Добавить' : 'Редактировать' ?> класс <span class="sparkline bar" data-type="bar"></span></h3>
    </div>
