        ...
        <div class="row">
            <div class="col-md-6">
                <h3 class="title">
                    ...
                    <a href="<?= Url::to(['/admin/park/service/edit', 'id' => 0]); ?>" class="btn btn-primary btn-sm rounded-s">
                        добавить
                    </a>
                </h3>
            </div>
    ...
    <ul class="item-list striped">
        <li class="item item-list-header hidden-sm-down">
            <div class="item-row">
                <div class="item-col item-col-header item-col-title">
                    <div> <span>Дополнительные услуги</span> </div>
                </div>
                            ...
                            <div class="item-actions-dropdown">
                                ...
                                <div class="item-actions-block">
                                    <ul class="item-actions-list">
                                        <li>
                                            <a class="remove" href="<?= Url::to(['/admin/park/service/delete', 'id' => $model->id]); ?>">
        ...
        <li class="item">
            <div class="item-row py-1">
                <small><em>список дополнительные услуг пуст...</em></small>
            </div>
        </li>
        <?php } ?>
    </ul>
