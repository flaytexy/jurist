...
<div class="item-editor-page">
    ...
    <div class="title-block">
        <h3 class="title"> <?= $model->isNewRecord ? 'Добавить' : 'Редактировать' ?> дополнительную услугу <span class="sparkline bar" data-type="bar"></span></h3>
    </div>
    ...
    <div class="col-sm-9 pull-sm-3">
        ...
        <div class="card menu-manage menu-manage-small">
            ...
            <div class="card-block">
                <div class="row">
                    <?=
                    $form->field($model, 'max_quantity', ['options' => ['class' => 'form-group col-sm-12']])
        ...
        <div class="card menu-manage menu-manage-small">
            ...
            <div class="card-block">
                <div class="row">
                    <?=
                    $form->field($model, 'price_1', ['options' => ['class' => 'form-group col-sm-6']])
                        ->textInput(['class' => 'form-control boxed']);
                    ?>
                    <?=
                    $form->field($model, 'price_15', ['options' => ['class' => 'form-group col-sm-6']])
                        ->textInput(['class' => 'form-control boxed']);
                    ?>
                </div>
            </div>
