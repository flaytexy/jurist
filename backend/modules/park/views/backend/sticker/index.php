    ...
    <div class="title-block">
        <div class="row">
            <div class="col-md-6">
                <h3 class="title">
                    Стикеры
                    <a href="<?= Url::to(['/admin/park/sticker/edit', 'id' => 0]); ?>" class="btn btn-primary btn-sm rounded-s">
                        добавить
                    </a>
                </h3>
            </div>
    ...
    <ul class="item-list striped">
                            ...
                            <div class="item-actions-dropdown">
                                ...
                                <div class="item-actions-block">
                                    <ul class="item-actions-list">
                                        <li>
                                            <a class="remove" href="<?= Url::to(['/admin/park/sticker/delete', 'id' => $model->id]); ?>">
        ...
        <li class="item">
            <div class="item-row py-1">
                <small><em>список стикеров пуст...</em></small>
            </div>
        </li>
        <?php } ?>
    </ul>
