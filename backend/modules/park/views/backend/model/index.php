        ...
        <div class="row">
            <div class="col-md-6">
                <h3 class="title">
                    Модели
                    <?php if ($brand_model) { ?>
                        марки "<?= $brand_model->getTitle() ?>"
                        <a href="<?= Url::to(['/admin/park/model/edit', 'id' => 0, 'brand_id' => $brand_model->id]); ?>" class="btn btn-primary btn-sm rounded-s">
                            добавить
                        </a>
                    <?php } else { ?>
                        <a href="<?= Url::to(['/admin/park/model/edit', 'id' => 0]); ?>" class="btn btn-primary btn-sm rounded-s">
                            добавить
                        </a>
                    <?php } ?>
                </h3>
    ...
    <ul class="item-list striped">
                            ...
                            <div class="item-actions-dropdown">
                                ...
                                <div class="item-actions-block">
                                    <ul class="item-actions-list">
                                        <li>
                                            <a class="remove" href="<?= Url::to(['/admin/park/model/delete', 'id' => $model->id]); ?>">
        ...
        <li class="item">
            <div class="item-row py-1">
                <small><em>список моделей пуст...</em></small>
            </div>
        </li>
        <?php } ?>
    </ul>
