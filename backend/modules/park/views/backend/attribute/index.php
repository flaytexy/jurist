    ...
    <div class="title-block">
        <div class="row">
            <div class="col-md-6">
                <h3 class="title">
                    Характеристики
                    <a href="<?= Url::to(['/admin/park/attribute/edit', 'id' => 0]); ?>" class="btn btn-primary btn-sm rounded-s">
                        добавить
                    </a>
                </h3>
            </div>
    ...
    <ul class="item-list striped">
                ...
                <li class="item">
                    <div class="item-row">
                        ...
                        <div class="item-col fixed pull-left item-col-title">
                            ...
                            <div>
                                <a href="<?= Url::to(['/admin/park/attribute-value/index', 'attribute_id' => $model->id]) ?>">
                            ...
                            <div class="item-actions-dropdown">
                                ...
                                <div class="item-actions-block">
                                    <ul class="item-actions-list">
                                        <li>
                                            <a class="remove" href="<?= Url::to(['/admin/park/attribute/delete', 'id' => $model->id]); ?>">
        ...
        <li class="item">
            <div class="item-row py-1">
                <small><em>список характеристик пуст...</em></small>
            </div>
        </li>
        <?php } ?>
    </ul>
