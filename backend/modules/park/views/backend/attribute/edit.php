...
<div class="item-editor-page">
    ...
    <div class="title-block">
        <h3 class="title"> <?= $model->isNewRecord ? 'Добавить' : 'Редактировать' ?> характеристику <span class="sparkline bar" data-type="bar"></span></h3>
    </div>
    ...
    <div class="col-sm-3 push-sm-9">
        ...
        <div class="card card-block">
            ...
            <?=
            $form->field($model, 'show_in_filter')
                ->checkbox([
                    'class' => 'radio squared',
                    'label' => '<span>' . $model->getAttributeLabel('show_in_filter') . '</span>'
                ]);
            ?>
