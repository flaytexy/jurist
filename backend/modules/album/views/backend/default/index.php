    ...
    <div class="title-block">
        <div class="row">
            <div class="col-md-6">
                <h3 class="title">
                    Галереи
                    <a href="<?= Url::to(['/admin/album/default/edit', 'id' => 0]); ?>" class="btn btn-primary btn-sm rounded-s">
                        добавить
                    </a>
                </h3>
            </div>
                            ...
                            <div class="item-actions-dropdown">
                                ...
                                <div class="item-actions-block">
                                    <ul class="item-actions-list">
                                        <li>
                                            <a class="remove" href="<?= Url::to(['/admin/album/default/delete', 'id' => $model->id]); ?>">
