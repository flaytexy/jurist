    ...
    <div class="title-block">
        <div class="row">
            <div class="col-md-6">
                <h3 class="title">
                    Слайды
                    <a href="<?= Url::to(['/admin/page/slider/edit', 'id' => 0]); ?>" class="btn btn-primary btn-sm rounded-s">
                        добавить
                    </a>
                </h3>
            </div>
    ...
    <ul class="item-list striped">
                            ...
                            <div class="item-actions-dropdown">
                                ...
                                <div class="item-actions-block">
                                    <ul class="item-actions-list">
                                        <li>
                                            <a class="remove" href="<?= Url::to(['/admin/page/slider/delete', 'id' => $model->id]); ?>">
        ...
        <li class="item">
            <div class="item-row py-1">
                <small><em>список слайдов пуст...</em></small>
            </div>
        </li>
        <?php } ?>
    </ul>
