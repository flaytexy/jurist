...
console.log(_startLeftTime);
console.log(_endLeftTime);
                    //倒计时未开始
                    if(_startLeftTime > 0){
            			...
            			if(_endLeftTime > 0){
                            $(v).html([
            					'<li class="item"><i class="day">'+_day+'</i><span> дней</span></li>',
            					'<li class="blank">:</li>',
            					'<li class="item"><i class="hour">'+_hour+'</i><span> часов</span></li>',
            					'<li class="blank">:</li>',
            					'<li class="item"><i class="minute">'+_minite+'</i><span> минут</span></li>'
            				].join(' '));
